...
Image_Stack_New_Env=abs(Image_Stack_New);
Image_Stack_New_Env_dB=10*log10(Image_Stack_New_Env);
%%
for rr=1:size(Image_Stack_New_Env,1)
    Temp_Enface(:,:)=(Image_Stack_New_Env_dB(rr,:,:));
    imwrite(Temp_Enface,sprintf('Enface_Sam_%i.bmp',rr));%,'Bitdepth',new_bit_depth);
