...
original_interrogation_size=30;
interpolation=5;
...
hold on
h=quiver(cordinate_Y+original_interrogation_size/2,cordinate_X+original_interrogation_size/2,V_CM_Y,V_CM_X,'linewidth',2,'color',[1 1 1]);%'linewidth',2,'color',[0 0 0],'xdata',0:Lateral_Spacing:Lateral_Spacing*(size(Curvature_P1,2)-1),'ydata',0:Lateral_Spacing:Lateral_Spacing*(size(Curvature_P1,1)-1));
hold off
