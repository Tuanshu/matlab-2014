...
cd('D:\Users\TuanShu\140623\');
%% background

Sam=double(dlmread('140623_sam'));
Ref=double(dlmread('140623_ref'));
Bs=double(dlmread('140623_bs'));

Background=Sam+Ref-Bs;

for N=1:1
N=2;
if N==2
    Image=double(dlmread(sprintf('140623_12bit_%d',2)))-double(dlmread(sprintf('140623_12bit_%d',10)));
elseif N==3
    Image=double(dlmread(sprintf('140623_12bit_%d',3)))-double(dlmread(sprintf('140623_12bit_%d',10)));
elseif N==4
    Image=double(dlmread(sprintf('140623_12bit_%d',4)))-double(dlmread(sprintf('140623_12bit_%d',10)));

elseif N==5
    Image=double(dlmread(sprintf('140623_12bit_%d',5)))-double(dlmread(sprintf('140623_12bit_%d',2)));

elseif N==6
    Image=double(dlmread(sprintf('140623_12bit_%d',6)))-double(dlmread(sprintf('140623_12bit_%d',2)));
elseif N==7
    Image=double(dlmread(sprintf('140623_12bit_%d',7)))-double(dlmread(sprintf('140623_12bit_%d',2)));
elseif N==8
    Image=double(dlmread(sprintf('140623_12bit_%d',8)))-double(dlmread(sprintf('140623_12bit_%d',2)));
elseif N==9
    Image=double(dlmread(sprintf('140623_12bit_%d',9)))-double(dlmread(sprintf('140623_12bit_%d',2)));
elseif N==10
    Image=double(dlmread(sprintf('140623_12bit_%d',10)))-double(dlmread(sprintf('140623_12bit_%d',2)));
end
