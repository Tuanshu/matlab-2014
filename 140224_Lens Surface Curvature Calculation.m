...
Surface_profile_reduced=interp2(X_temp,Y_temp,Surface_profile_Ave,X_temp_reduced,Y_temp_reduced,'cubic');
...
Z=(Surface_profile_New-max(max(Surface_profile_New))).*d_Position.*mask;
Z(isnan(Z))=0;
