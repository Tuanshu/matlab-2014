...
TH_first_peak=0.1;
TH_second_peak=0.01;
Delay_first_peak=70000*5; %the smaller one, pixel
Min_thickness=12000*5; %pixel

Max_thickness=16000*5; %pixel

cd('D:\Users\TuanShu\120717_40k_deeper focus alignment\');
...
Window1=(gaussmf(Frequency,[0.2E14 1E14]));
Window1(Frequency>1E14)=1;
...
dlmwrite('Data_New_real.txt',real(Data_New),'delimiter','\t','newline','pc');

dlmwrite('Data_New_abs.txt',abs(Data_New),'delimiter','\t','newline','pc');
