...
Ratio_Upper2Reference=0.835;%0.835;%0.835; %if the front interface has larger interference eff than referential glass, Ratio_Upper2Reference>1
Thickness=[8.2/1.6]'*1E-6;      %Initial Value
if load_nk ==1
...
dlmwrite('Signal_Sample_1.txt',real(Signal_Sample_1)/max_Signal_Sample_2,'delimiter','\t','newline','pc');
dlmwrite('Signal_Sample_2.txt',real(Signal_Sample_2)/max_Signal_Sample_2,'delimiter','\t','newline','pc');
dlmwrite('Signal_Sample.txt',real(Signal_Sample)/max_Signal_Sample_2,'delimiter','\t','newline','pc');
